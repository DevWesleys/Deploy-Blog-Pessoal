package br.com.blogpessoal.blogpessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.com.blogpessoal.blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/DevWesleys")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Wesley Santana", 
			"https://github.com/DevWesleys", 
			"itsbaianoman@gmail.com");
